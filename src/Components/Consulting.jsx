   ...
   <motion.div
    ...
    >
      ...
      <Box sx={{ flex: 1 }}>
        ...
        >
          We partner with organizations to design and implement future-ready digital strategies. 
          Our consultants bring deep expertise in technology, industry trends, and process optimization.
        </Typography>
      </Box>
    </Box>
     <Box
    ...
    >
      ...
      <Box flex={1}>
        ...
        >
          Helps organizations optimize operations, reduce costs, 
          and build resilience in an evolving digital economy.
