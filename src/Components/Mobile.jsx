   ...
   <motion.div
    ...
    >
      ...
      <Box sx={{ flex: 1 }}>
        ...
        >
         In today’s mobile-first world, apps are the fastest way to engage customers. 
         We create high-performance mobile applications that combine scalability, security,
    ...
    >
      ...
      <Box flex={1}>
        ...
        >
         Delivers apps that strengthen customer engagement, 
         increase loyalty, and open new revenue streams.
        </Typography>
